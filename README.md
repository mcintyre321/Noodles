...
Noodles is a .NET library for building model driven web/API applications on top of ASP MVC or WebApi. Basically you write your business logic and it gets transformed into a 21st century web application. You might call it an OIM (Object-Interface mapper), and like ORMs, it has plenty of conventions, and plenty of places to override those conventions.
