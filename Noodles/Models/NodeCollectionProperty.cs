...
namespace Noodles.Models
{
    ...
    //public class XNodeCollectionProperty<TParent> : ReflectionNodeProperty<TParent>, NodeCollectionProperty, NodeProperty where TParent : INode
    //{
    //    private readonly Type _collectionItemType;

    //    public XNodeCollectionProperty(TParent parent, object target, PropertyInfo info, Type collectionItemType)
