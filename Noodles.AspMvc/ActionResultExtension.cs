...
namespace Noodles.AspMvc
{
    public static class ActionResultExtension
    {
        ...
        //public static List<Func<ControllerContext, object, ActionResult>> Processors =
        //    new List<Func<ControllerContext, object, ActionResult>>();

        //private static List<Func<Exception, ControllerContext, Action>> ModelStateExceptionHandlers =
        //    new List<Func<Exception, ControllerContext, Action>>();
        ...
        //    ModelStateExceptionHandlers.Add(
        //        (e, msd) => (e as NodeNotFoundException) == null ? null as Action : () => action((TEx) e, msd));
